  ...
  <v-app id="inspire">
    <div>
      <v-app-bar color="primary" app clipped-left flat>
        <v-toolbar-title>
          <span class="second-word font uppercase" style="font-weight: 700">
            <v-app-bar-nav-icon
              @click="openSideBar()"
              style="
                z-index: 1;
    ...
    <v-main>
      ...
      <v-container style="padding: 0px" v-else fluid>
        <div style="width: 100%; margin: 0px 0px 20px 0px; position: relative">
          <v-img style="width: 100%; height: 300px" src=""></v-img>
        ...
        <v-row>
          <v-col
            ...
            v-for="(aggregate, index) in aggregate"
            :key="index"
          >
            <div
              class="flip-card"
